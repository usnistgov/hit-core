...
public class HTTPSecurityFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		String scriptHashes = "";//"'sha256-MwG2cQ2U9AYTcxzDnJ272QPMX6fhfnMgrSKJs25/zWw=' 'sha256-HSx22tN7dkvAJ5oPJefULXe6d/M6XWfIzGWpAGVQiaY=' 'sha256-MwG2cQ2U9AYTcxzDnJ272QPMX6fhfnMgrSKJs25/zWw='";
...
//				httpResponse.setHeader("Access-Control-Allow-Origin", "");
				...
				//new
//				httpResponse.setHeader("Content-Security-Policy", "default-src 'self';  script-src 'self'  https://www.youtube.com  https://www.googletagmanager.com https://googletagmanager.com https://dap.digitalgov.gov  "+scriptHashes+"; img-src 'self' data: https://*.google-analytics.com https://*.googletagmanager.com https://*.g.doubleclick.net https://*.google.com ; style-src 'self' 'unsafe-inline' 'unsafe-eval' "+styleHashes+"; font-src 'self'; frame-src 'self' https://td.doubleclick.net https://www.googletagmanager.com; object-src 'none'; connect-src 'self' https://*.google-analytics.com https://*.googletagmanager.com https://*.g.doubleclick.net https://*.google.com  https://pagead2.googlesyndication.com https://dap.digitalgov.gov");
