...
public class UserUtil {
  ...
  public static final String[] AUTHORITY_LIST = {"user", "tester", "supervisor", "publisher", "deployer", "admin"};
  public static final String[] ACCOUNT_TYPE_LIST = {"tester", "supervisor", "publisher", "deployer", "admin"};
